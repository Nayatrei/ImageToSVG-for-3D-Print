import { createAnnotateTabController } from './modules/tabs/annotate-tab.js?v=r-78ade4c03db6e3a2';
import { createBulkTabController } from './modules/tabs/bulk-tab.js?v=r-78ade4c03db6e3a2';
import { createRasterTabController } from './modules/tabs/raster-tab.js?v=r-78ade4c03db6e3a2';
import { createSvgTabController } from './modules/tabs/svg-tab.js?v=r-78ade4c03db6e3a2';
import { createLogoTabController } from './modules/tabs/logo-tab.js?v=r-78ade4c03db6e3a2';
import { createPdfTabController } from './modules/tabs/pdf-tab.js?v=r-78ade4c03db6e3a2';
import {
    getDataUrlSize,
    getFileStem,
    getImageFormat,
    ...
    normalizeImageBlob
} from './modules/raster-utils.js?v=r-78ade4c03db6e3a2';
...
import { isHeicFile } from './modules/shared/heic.js?v=r-78ade4c03db6e3a2';
import { createElements } from './modules/app-elements.js?v=r-78ade4c03db6e3a2';
import { createState } from './modules/app-state.js?v=r-78ade4c03db6e3a2';
import { applyTabCase, TAB_CASES } from './modules/tab-cases.js?v=r-78ade4c03db6e3a2';
import { bindMagnetPocketControls } from './modules/shared/magnet-pocket-controls.js?v=r-78ade4c03db6e3a2';
...
async function initializeApplication() {
    ...
    async function convertHeicForImport(file, updateImportProgress, progress = 0.08) {
        ...
        const { decodeHeicToBlob } = await import('./modules/shared/heic.js?v=r-78ade4c03db6e3a2');
